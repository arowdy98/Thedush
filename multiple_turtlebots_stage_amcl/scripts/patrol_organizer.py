...
#     
    def __init__(self, availableRobots=['robot_0', 'robot_1'], listOfPositions={'robot_0':[(2.8,1), (2.8,5)], 'robot_1':[(1.5,3), (5,3)]}):
...
def main():
    ...
    # coordinator = PatrolCoordinator(availableRobots=['robot_0', 'robot_1'], listOfPositions={'robot_0':[(2.8,1), (2.8,5)], 'robot_1':[(1.5,3), (5,3)]})
    # coordinator = PatrolCoordinator(availableRobots=['robot_0', 'robot_1'], listOfPositions={'robot_0':[(2.8,1), (1,3), (2.8,5), (5,4)], 'robot_1':[(1,1), (3,3), (1,5), (4,3)]})
    coordinator = PatrolCoordinator(availableRobots=['robot_0', 'robot_1'], listOfPositions={'robot_0':[(3,0.75), (7,0.75)], 'robot_1':[(2,0.75), (6,0.75)]})
